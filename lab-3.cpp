...
int main(int argc, const char* argv[]) {
    ...
    for (int i = 0; i < 15; i++)
        for (int j = 14; j > i; j--)
            if (SortArr[i] > SortArr[j])swap(SortArr[i], SortArr[j]); 
    ...
    {
        cout << "Первый массив: ";
        for (int i = 0; i < 14; i++) cout << OldFirstArr[i] << " ";
        cout << OldFirstArr[14] << endl;
        cout << "Второй массив: ";
        for (int i = 0; i < 14; i++) cout << OldSecondArr[i] << " ";
        cout << OldSecondArr[14] << endl;
        cout << "Минимумы: " << mn_1 << " " << mn_2 << " " << mn_3 << endl;
        cout << "Сортировка: ";
        for (int i = 0; i < 14; i++) cout << SortArr[i] << " ";
        cout << SortArr[14] << endl;
        cout << "Повторы: " << Replay << endl;
        cout << "Степень 2: " << Two << endl;
        cout << "Перераспределение 1 массива: ";
        for (int i = 0; i < 14; i++) cout << NewFirstArr[i] << " ";
        cout << NewFirstArr[14] << endl;
        cout << "Перераспределение 2 массива: ";
        for (int i = 0; i < 14; i++) cout << NewSecondArr[i] << " ";
        cout << NewSecondArr[14] << endl;
    }
    else
    {
        for (int i = 0; i < 14; i++) cout << OldFirstArr[i] << " ";
